...
table1 = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Data 2021 0708-run.xlsx', sheet_name = 'Target2')
...
yrs = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Final Scenario 2021 0708.xlsx', sheet_name = 'Yr_Index')

# COM
data = table.drop(['lelc', 'lind', 'lres', 'ltrn',  'lgdp_man', 'lche', 'lfoo', 'lmac', 'ltex', 'loth', 'lgasprice', 'loilprice'], axis = 1)

r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Scenarios 2021 0708.xlsx', sheet_name = 'COM')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Scenarios 2021 0708.xlsx', sheet_name = 'IND')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Scenarios 2021 0708.xlsx', sheet_name = 'IND2')
...
for i in country_name:
    if i != 'ALL':
        if i in ref_country:
            ...
            x_labels = country_filter[['xi0','xi1','xi2','xi3','xi4','x5','x6','x7','y']]
            ...
            entry2 = pd.DataFrame({'Country ID': [rid, rid, rid, rid,rid, rid, rid, rid, rid],
                                   ...
                                   'CoeID': ['intercept', 'xi0', 'xi1', 'xi2', 'xi3', 'xi4', 'x5', 'x6', 'x7'],
                                   'Coe': [export_val1[export_val1['labels']=='intercept']['coef'].to_list()[0], export_val1[export_val1['labels']=='xi0']['coef'].to_list()[0], export_val1[export_val1['labels']=='xi1']['coef'].to_list()[0], export_val1[export_val1['labels']=='xi2']['coef'].to_list()[0], export_val1[export_val1['labels']=='xi3']['coef'].to_list()[0], export_val1[export_val1['labels']=='xi4']['coef'].to_list()[0], export_val1[export_val1['labels']=='x5']['coef'].to_list()[0], export_val1[export_val1['labels']=='x6']['coef'].to_list()[0], export_val1[export_val1['labels']=='x7']['coef'].to_list()[0]],
                                   'tvalueID': ['t_intercept', 't_xi0', 't_xi1', 't_xi2', 't_xi3', 't_xi4', 't_x5', 't_x6', 't_x7'],
                                   'tvalue': [export_val1[export_val1['labels']=='intercept']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='xi0']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='xi1']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='xi2']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='xi3']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='xi4']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='x5']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='x6']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='x7']['t-statistic'].to_list()[0]]})
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Scenarios 2021 0708.xlsx', sheet_name = 'IND3')
...
for i in country_name:
    if i != 'ALL':
        if i in ref_country:
                ...
                x_labels = country_filter[['x0','x1','xi0','xpg','xpo','x5','x6','x7', 'x8', 'x9',  'y']]
                rid = country_filter['Country ID'].tolist()[0]
                y_var = x_labels['y'].to_list()[0]
                ...
                for i in aclist:
                    ...
                    entry2 = pd.DataFrame({'Country ID': [rid, rid, rid, rid,rid, rid, rid, rid, rid, rid, rid],
                                   'R-square': [results.rsquared, results.rsquared, results.rsquared, results.rsquared, results.rsquared, results.rsquared, results.rsquared, results.rsquared, results.rsquared, results.rsquared, results.rsquared],
                                   'RegType': [a, a, a, a, a, a, a, a, a, a, a],
                                   'CoeID': ['intercept', 'x0', 'x1', 'xi0', 'xpg', 'xpo', 'x5', 'x6', 'x7', 'x8', 'x9'],
                                   'Coe': [export_val1[export_val1['labels']=='Intercept']['coef'].to_list()[0], export_val1[export_val1['labels']=='x0']['coef'].to_list()[0], export_val1[export_val1['labels']=='x1']['coef'].to_list()[0], export_val1[export_val1['labels']=='xi0']['coef'].to_list()[0], export_val1[export_val1['labels']=='xpg']['coef'].to_list()[0], export_val1[export_val1['labels']=='xpo']['coef'].to_list()[0], export_val1[export_val1['labels']=='x5']['coef'].to_list()[0], export_val1[export_val1['labels']=='x6']['coef'].to_list()[0], export_val1[export_val1['labels']=='x7']['coef'].to_list()[0], export_val1[export_val1['labels']=='x8']['coef'].to_list()[0], export_val1[export_val1['labels']=='x9']['coef'].to_list()[0]],
                                   'tvalueID': ['t_intercept', 't_x0', 't_x1', 't_xi0', 't_xpg', 't_xpo', 't_x5', 't_x6', 't_x7', 't_x8', 't_x9'],
                                   'tvalue': [export_val1[export_val1['labels']=='Intercept']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='x0']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='x1']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='xi0']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='xpg']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='xpo']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='x5']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='x6']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='x7']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='x8']['t-statistic'].to_list()[0], export_val1[export_val1['labels']=='x9']['t-statistic'].to_list()[0]]})
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Scenarios 2021 0708.xlsx', sheet_name = 'RES')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Scenarios 2021 0708.xlsx', sheet_name = 'TRN')
...
order = ['Country ID', 'Country', 'Sector','R-square', 'RegType', 'RegID', 'CoeID', 'Coe', 'tvalueID', 'tvalue']
...
totalresult.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Total Results 2021 0708.csv',index=None)
totalforecast.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Total Forecast 2021 0708.csv',index=None)
...
totalregID.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Total RegID 2021 0708.csv',index=None)
totalcagr.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Total CAGR 2021 0708.csv',index=None)
...
########## final selection
select = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Final Scenario 2021 0708.xlsx', sheet_name = 'Map')
...
selectresult.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Final Results 2021 0708.csv',index=None)
selectforecast.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Final Forecast 2021 0708.csv',index=None)
selectcagr.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Final CAGR 2021 0708.csv',index=None)
