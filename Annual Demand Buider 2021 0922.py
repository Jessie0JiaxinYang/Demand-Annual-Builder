...
table1 = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Data 2021 0922-run.xlsx', sheet_name = 'Target2')
table =table1.iloc[6:, 31: ]

table.columns = [ 'Country', 'Year', 'lcom', 'lelc', 'lind', 'lres', 'ltrn', 'lpet' ,'lgdp', 'lppl', 'lgdpp', 'lgdp_man', 'lche', 'lfoo', 'lmac', 'ltex', 'loth', 'luppl', 'llf', 'lgop', 'lgou', 'lpou', 'lgasprice', 'loilprice','coviddummy']
...
yrs = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Final Scenario 2021 0922.xlsx', sheet_name = 'Yr_Index')

# COM
data = table.drop(['lelc', 'lind', 'lres', 'ltrn', 'lpet', 'lgdp_man', 'lche', 'lfoo', 'lmac', 'ltex', 'loth', 'lgasprice', 'loilprice'], axis = 1)

r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Scenarios 2021 0922.xlsx', sheet_name = 'COM')
    ...
    if i != 'ALL':
        if i in ref_country:
                ...
                for i in aclist:
                    ...
                    test = forecast_var[forecast_var['Year']>2019]
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Scenarios 2021 0922.xlsx', sheet_name = 'IND')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Scenarios 2021 0922.xlsx', sheet_name = 'IND2')
...
for i in country_name:
    if i != 'ALL':
        if i in ref_country:
            ...
            train = regressors[regressors['Year']<=2020]
            test = regressors[regressors['Year']>2019]
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Scenarios 2021 0922.xlsx', sheet_name = 'IND3')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Scenarios 2021 0922.xlsx', sheet_name = 'RES')
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Scenarios 2021 0922.xlsx', sheet_name = 'TRN')
...
totalresult.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Total Results 2022 0921.csv',index=None)
totalforecast.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Total Forecast 2022 0921.csv',index=None)
...
totalregID.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Total RegID 2021 0922.csv',index=None)
totalcagr.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Total CAGR 2021 0922.csv',index=None)
...
########## final selection
select = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Final Scenario 2021 0922.xlsx', sheet_name = 'Map')
...
selectresult.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Final Results 2021 0922.csv',index=None)
selectforecast.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Final Forecast 2021 0922.csv',index=None)
selectcagr.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Final CAGR 2021 0922.csv',index=None)
