...
table1 = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Data 2021 0921-run.xlsx', sheet_name = 'Target2')
...
for i in country_name:
    if i != 'ALL':
        if i in ref_country:
                ...
                allcombs.append(['lgdp' , 'lppl'])
                allcombs.append(['lgdp' , 'luppl'])
                allcombs.append(['lgdpp' , 'llf'])
                allcombs.append(['lgdpp' , 'luppl'])
                allcombs.append(['lppl' , 'luppl'])
                allcombs.append(['lgdp', 'lppl', 'lgdpp'])
...
for i in country_name:
    if i != 'ALL':
        if i in ref_country:
                ...
                allcombs.append(['lgdp_man'])
                allcombs.append(['lgdp' , 'lppl'])
                allcombs.append(['lppl', 'lgdp_man'])
                allcombs.append(['lgdp', 'lppl', 'lgop'])
...
ind_regid = ind_regid.append({'RegType': 'lche + lfoo + lmac + ltex + loth', 'RegID': 'ind007'}, ignore_index=True)
...
r_table = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Scenarios.xlsx', sheet_name = 'IND3')
...
allcombs2  = DataFrame(aclist)
allcombs2["ID"] =  range(len(allcombs2)) 
# 7 will be replaced if the numbers 0f IND+IND2 changes
allcombs2["ID"] = allcombs2["ID"] + 7
allcombs2["Sector"] = "ind"
allcombs2['RegID'] = allcombs2['ID'].apply(lambda x: 'ind00' + str(x)  if x<10 else 'ind0' +str(x) if x<100 else 'ind' + str(x))
allcombs2.columns = ['RegType', 'ID', 'Sector', 'RegID']
allcombs2['RegType']  = allcombs2['RegType'].str.replace("lind~", "")
...
totalresult.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Total Results 2021 0921.csv',index=None)
totalforecast.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Total Forecast 2021 0921.csv',index=None)
...
totalregID.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Total RegID 2021 0921.csv',index=None)
totalcagr.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Total CAGR 2021 0921.csv',index=None)
...
########## final selection
select = pd.read_excel(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Input Final Scenario.xlsx', sheet_name = 'Map')
...
selectresult.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Final Results 2021 0921.csv',index=None)
selectforecast.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Final Forecast 2021 0921.csv',index=None)
selectcagr.to_csv(r'C:\Users\jiaxi\OneDrive\桌面\RBAC 2021\Demand Annual Builder\Final CAGR 2021 0921.csv',index=None)
